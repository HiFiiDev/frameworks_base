        ...
        public void update() {
            ...
            mBatteryLightEnabled = Settings.System.getInt(resolver,
                    Settings.System.BATTERY_LIGHT_ENABLED, mContext.getResources().getBoolean(
                        com.android.internal.R.bool.config_intrusiveNotificationLed) ? 1 : 0) == 1;
            updateLed();
        }
    }
        ...
        public void updateLightsLocked() {
            ...
            if (status == BatteryManager.BATTERY_STATUS_CHARGING && mBatteryLightEnabled) {
                if (level < mLowBatteryWarningLevel) {
                    ...
                    // Solid green when nearly full and charging
                ...
                // Not charging or battery light disabled, turn off LED
